...
def gilbert_xyz2d(x, y, z, width, height, depth, axis_order=None):
    """
    ...
    if axis_order is not None:
        ...
        (_, maj_vec) = axes[axis_order[0]]
        (_, mid_vec) = axes[axis_order[1]]
        (_, min_vec) = axes[axis_order[2]]

        return gilbert_xyz2d_r(
            0, x, y, z,
            0, 0, 0,
            *maj_vec,
            *mid_vec,
...
def gilbert_mapping(t, h, w, transpose_order=None, axis_order=("w","h","t")):
    """
        ...
        for z in range(t):
            for y in range(h):
                for x in range(w):
                    ...
                    # Calculate Gilbert curve index
                    hilbert_idx = gilbert_xyz2d(x, y, z, w, h, t, axis_order)
...
def gilbert_block_neighbor_mapping(t, h, w, block_size=128, transpose_order=None, axis_order=("w","h","t")):
    """
